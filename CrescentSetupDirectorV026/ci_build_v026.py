...
WORK = Path(os.environ.get('RUNNER_TEMP', HERE / '_tmp')) / 'csd_v026'
SOURCE = WORK / 'source'
...
REPORTS = ART / 'REPORTS'
VERSION = '0.2.6'
BUILD_ID = 'CSD_V026_API15_NET10_WORKFLOW_RECOVERY_20260826_R2'
SOURCE_ARCHIVE = WORK / 'source_v0.2.6.tar.gz'
SOURCE_ARCHIVE_SHA256 = '4677b2d485e37a33bd08585bd24a157134d093714a43fe68fd4417d5891571a8'
...
def main() -> None:
    ...
    chunks = sorted((HERE / 'chunks').glob('source_v0.2.6.b64.*'))
    if not chunks:
    ...
    if manifest.get('AssemblyVersion') != '0.2.6.0' or manifest.get('DalamudApiLevel') != 15:
        raise SystemExit(f'bad manifest: {manifest}')

    source_zip = ART / 'Crescent_Setup_Director_v0.2.6_SOURCE_VERIFIED.zip'
